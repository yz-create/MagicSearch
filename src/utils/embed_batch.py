...
def card_to_text_detailed(card: dict) -> str:
    ...
    text = f"This is a MTG card with the name {name}. It costs {cost} to play. It is a {card_type}. It is described as follows: {description}."
...
if __name__ == "__main__":
    ...
    print(f"FO1a : Génération de deux embeddings par carte (short + detailed)")
